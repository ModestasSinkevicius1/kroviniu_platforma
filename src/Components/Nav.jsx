    ...
    return (       
        <nav>
            <div className="nav-control">
                ...
                <NavLink to="/home/boxes" className={ ({ isActive }) => isActive ? 'nav-link active' : 'nav-link'}>Boxes</NavLink>
                <NavLink to="/home/containers" className={ ({ isActive }) => isActive ? 'nav-link active' : 'nav-link'}>Containers</NavLink>
            </div>
